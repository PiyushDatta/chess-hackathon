...
def get_args_parser():
    ...
    parser.add_argument("--load-path", help="path to checkpoint.pt file to resume from", type=Path, default="/root/chess-hackathon/checkpoint.pt")
...
def main(args, timer):
    using_local_gpu = True
    # if not using_local_gpu:
    os.environ["RANK"] = "0"
